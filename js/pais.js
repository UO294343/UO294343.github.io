    ...
    cargarDatos() {
        $.ajax({
            ...
            success: function(datos) {
                let pronosticoContainer = $("main section").eq(1);
                    ...
                    if (hora === "12:00:00" && diasAgregados.size < 5 && !diasAgregados.has(fecha)) {  
                        ...
                        let diaHtml = `
                            <article>
                                ...
                                <img src="http://openweathermap.org/img/wn/${icono}@4x.png" alt="Icono del tiempo">
                            </article>`;
            ...
            error: function() {
                $("main section").eq(1).html("¡Tenemos problemas! No puedo obtener XML de <a href='http://openweathermap.org'>OpenWeatherMap</a>");
            }
        });
    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    mainElement.insertAdjacentHTML("beforeend", informacionPais);

    mainElement.insertAdjacentHTML("beforeend", `<section></section>`);
