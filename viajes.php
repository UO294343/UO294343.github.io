...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDHPlVboVe4tAPPNCVNUv3utDaydnXmBk8&loading=async&libraries=marker"></script>
...
<body>
    ...
    <main>
        ...
        <section>
            <h3>Mapa</h3>
            <img alt="Mapa estático" src="none"/>
            <div></div>
        </section>
